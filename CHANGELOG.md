...
- Presents one compact notch cue without a duplicate system banner.
- Keeps completion cues alive without delaying the terminal prompt.
- Returns to the original Terminal tab when it is still available.
...
- Added the explicit manual updater.
